...
Overall, according to **Figure 2**, there is no clear indication on which gender is heavier. In the Bonanza Lowland site, females are lighter than males and there was not enough data in this site to get a mean for unknown gendered hares. There was only one sample collected and there was no mass measurement. In the Bonanza Mature site, males hare the heaviest but both females and unknown gendered hares have higher variances in their masses. In the Bonanza Riparian site, females have the largest mass while unknown gendered hares have the most variance. 
...
lm_glance <- glance(hare_lm) %>% 
  mutate(intercept = round(lm_tidy$estimate[1],2), # extracts slope value from model fit
         slope = round(lm_tidy$estimate[2],3), # extracts intercept value from model fit
